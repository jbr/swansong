...
- add guard location reporting with #[track_caller]

### Other

- *(deps)* update swatinem/rust-cache action to v2.9.2
- *(deps)* update rust crate event-listener to v5.4.2
...
- add ShuttingDown future

### Fixed

- swansong tree implementation incorrectly prevented shutdowns

### Other

- add tsan job
- *(deps)* update rust crate tokio to v1.52.1
- *(deps)* update rust crate tokio to v1.52.0
...
- *(deps)* update rust crate fastrand to v2.4.1
- *(deps)* update rust crate fastrand to v2.4.0
